...
public class QuizzCreationBtn extends JButton implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if ("Suivant".equals(this.getText())) {
            ...
            quizzScreenQuestionCreation.imageQuestion.setText("");
        } else if ("Sauvegarder".equals(this.getText())) {
            quizzScreenAddImage.setVisible(false);
        } else if ("Visualiser".equals(this.getText())) {
            if (!quizzScreenQuestionCreation.imageQuestion.getText().toString().equals("")) {
                try {
